...
ax_coverage.set_title('Compared Map Coverage Over Time For Both Approaches', pad=20)
...
plt.tight_layout()
plt.savefig('./combined_robots_coverage_plot.png', dpi=300, bbox_inches='tight')  # Higher DPI for better quality
print(f"Combined plot saved as 'combined_robots_coverage_plot.png'")