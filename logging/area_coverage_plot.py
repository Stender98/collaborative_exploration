...
csv_files = [
    '../logs/centralised/5/1/coverage.csv',
    '../logs/centralised/5/2/coverage.csv',
    '../logs/centralised/5/3/coverage.csv'
]
...
ax_coverage.set_title('Map Coverage Over Time Across Multiple Trials')
...
plt.tight_layout()
plt.savefig('coverage_and_robots_plot.png')
